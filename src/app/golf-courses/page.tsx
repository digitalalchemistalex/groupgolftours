...
export const metadata: Metadata = {
  ...
  description: 'Preferred tee time access at Pebble Beach (From $675/round), Shadow Creek ($1,250), Edgewood Tahoe, Torrey Pines, and 200+ US courses. Group rates, 20+ years of relationships.',
      ...
      <section style={{ background:'#080C08', padding:'clamp(80px,10vw,130px) 0 clamp(60px,8vw,100px)', position:'relative', overflow:'hidden', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div className="section-wrap" style={{ maxWidth:'var(--max)', position:'relative', zIndex:1 }}>
          ...
          <p style={{ fontSize:17, lineHeight:1.82, color:'rgba(245,237,216,0.62)', maxWidth:580, marginBottom:36, fontWeight:300 }}>
            Pebble Beach at From $675/round requires a resort stay booked up to 18 months out. Shadow Creek at $1,250/round is MGM hotel guests only. Edgewood Tahoe. Torrey Pines South. We hold preferred relationships at 200+ courses across every destination we serve — and we secure the times your group wants.
          </p>
