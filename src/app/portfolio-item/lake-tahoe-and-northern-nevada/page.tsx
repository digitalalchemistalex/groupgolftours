  ...
  return (
    <DestinationPage
      ...
      highlights={[
        ...
        { icon: '🏌️', title: 'Course variety at every budget', desc: 'From Lakeridge at From $275/person packages up to Edgewood Tahoe at $4,119 — we match the course to your group\'s budget.' },
      ...
      courses={[
        ...
        { name: 'Red Hawk Golf Resort', type: 'Public · Reno', green_fee: 'From $499/person', highlight: 'Hills Course and Lakes Course. Packages from $499 (4 nights, 3 rounds) to From $977 (5 nights, 4 rounds). Full resort amenities.', booking_note: 'From $499/person packages' },
      ...
      faqs={[
        {
          ...
          a: 'Our lowest documented Reno group golf package is From $275/person for a 1-night, 2-round trip at Lakeridge Golf Course. Reno casino hotel rates are low enough that short 1–2 night packages with multiple rounds are very achievable at budget-friendly per-person prices. Wolf Run 2-night/3-round packages start at From $395/person.',
        },
        {
