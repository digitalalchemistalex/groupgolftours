...
export const metadata: Metadata = {
  ...
  description: 'Southern California group golf packages. Torrey Pines South (From $277–From $345/round non-resident), PGA West, Pelican Hill. TripCaddie shows 5-night/4-round packages from $2,950/person.',
  ...
  openGraph: {
    ...
    description: 'Year-round championship golf in SoCal. Torrey Pines South: From $277–From $345/round for non-residents. 2× US Open host. Real packages from $2,950/person.',
...
export default function SouthernCalifornia() {
  return (
    <DestinationPage
      ...
      courses={[
        { name: 'Torrey Pines Golf Course — South', type: 'Municipal · La Jolla, CA', green_fee: 'From $277–From $345/round (non-resident)', highlight: '7,765 yards. 2× US Open host (2008 Tiger Woods — broken leg win, 2021 Jon Rahm). Annual Farmers Insurance Open PGA Tour venue. Non-resident fees: From $277 weekday, From $345 weekend. City of San Diego limits non-resident daily slots.', booking_note: 'Non-resident slots limited · advance booking required' },
        { name: 'Torrey Pines Golf Course — North', type: 'Municipal · La Jolla, CA', green_fee: 'From $194–From $241/round (non-resident)', highlight: 'Less intense than the South Course but still 7,258 yards. PGA Tour venue for Farmers Insurance Open. Non-resident fees From $194 weekday, From $241 weekend. More accessible tee times than the South Course.', booking_note: 'Better availability than South Course' },
      ...
      faqs={[
        {
          ...
          a: 'Torrey Pines South Course costs From $277 on weekdays and From $345 on weekends for non-residents in 2025. San Diego city residents pay From $69–From $87. The South Course is a 7,765-yard US Open venue that demands a significant skill level. The North Course runs From $194–From $241 for non-residents and offers a more accessible experience on the same clifftop property.',
        },
        {
          q: 'What are the best golf courses in Southern California for groups?',
          a: 'For groups, Torrey Pines (North and South) in La Jolla is the top public-access option — a 2× US Open venue with ocean views at From $194–From $345/person. Pelican Hill in Newport Beach offers resort luxury. PGA West in La Quinta suits groups that want desert golf with attached resort amenities. For a complete SoCal tour, we build 5–7 day itineraries combining coastal and desert courses.',
        },
        {
