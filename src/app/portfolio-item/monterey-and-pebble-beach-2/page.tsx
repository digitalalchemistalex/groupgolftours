...
export const metadata: Metadata = {
  ...
  description: 'Southern California group golf packages. Torrey Pines South ($277–From $345/round non-resident), PGA West, Pelican Hill. TripCaddie shows 5-night/4-round packages from $2,950/person.',
  ...
  openGraph: {
    ...
    description: 'Year-round championship golf in SoCal. Torrey Pines South: $277–From $345/round for non-residents. 2× US Open host. Real packages from $2,950/person.',
