...
export default function LasVegasSouthernNevada() {
  return (
    <DestinationPage
      ...
      openingCopy="Las Vegas sits in the Mojave Desert at 2,000 feet elevation, blessed with 300+ days of sunshine and surrounded by world-class golf that most groups never get access to on their own. Shadow Creek is the crown jewel — a Tom Fazio masterpiece built at a reported From $60 million cost in 1989, originally Steve Wynn's private club, now accessible only to MGM Resort hotel guests Monday through Thursday. The green fee is $1,250/person and includes a private limousine pickup from your MGM hotel, a personal caddie, and a round on the course where The Match has been played between golf's biggest names. Beyond Shadow Creek, TPC Las Vegas and Cascata provide resort-quality championship golf in the desert landscape. We coordinate the full experience — MGM hotel booking, Shadow Creek tee times, and any additional rounds — in one package."
      ...
      courses={[
        { name: 'Shadow Creek Golf Course', type: 'MGM Resort · North Las Vegas', green_fee: '$1,250/round', highlight: 'The most expensive public tee time in the United States. Tom Fazio design built at From $60M. Private limo and personal caddie included. Hosted Tiger vs. Phil (The Match), Rory/Scottie vs. Koepka/DeChambeau. Available Mon–Thu for MGM hotel guests only.', booking_note: 'MGM hotel stay required · Mon–Thu only' },
