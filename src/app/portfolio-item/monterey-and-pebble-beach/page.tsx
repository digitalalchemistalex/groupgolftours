...
export const metadata: Metadata = {
  title: 'Pebble Beach & Monterey Golf Packages | From $675/Round | Group Golf Tours',
  description: 'Group golf packages at Pebble Beach Golf Links (From $675/round), Spyglass Hill, Spanish Bay. Groups must book 12–18 months in advance. We secure tee times groups cannot get independently.',
  alternates: { canonical: 'https://www.groupgolftours.com/portfolio-item/monterey-and-pebble-beach/' },
  openGraph: {
    title: 'Pebble Beach Group Golf Packages — From $675/Round, 18-Month Advance Booking',
    description: 'Pebble Beach Groups can\'t book independently without a resort stay. We coordinate lodge rooms + tee times together. From $675/round, 6× US Open host.',
...
export default function MontereyPebbleBeach() {
  return (
    <DestinationPage
      ...
      heroSub="From $675/round. Ranked #1 public course in America. 6× US Open host. To book in advance, you must stay at the resort — with a minimum 2-night requirement. Groups who try to book independently get paired with strangers or shut out entirely. We secure your rooms and tee times together."
      stat1={{ n: 'From $675', label: 'Per Round · Pebble Beach Links' }}
      stat2={{ n: '18 months', label: 'Advance Booking Window' }}
      stat3={{ n: '6×', label: 'US Open Host Course' }}
      openingCopy="Pebble Beach Golf Links opened in 1919 on the cliffs of the Monterey Peninsula, where the Pacific Ocean crashes against the rocks on virtually every hole. It has hosted six US Open Championships — Watson's chip-in at 17 in 1982, Tiger's 15-shot dominance in 2000, and Jon Rahm's 2021 victory. The current green fee is From $675/person for resort guests. Non-guests can only book within 24 hours of their round, with essentially no chance of securing multiple consecutive tee times for a group. The only way to guarantee your group plays together is to stay at The Lodge at Pebble Beach or The Inn at Spanish Bay — which allows booking up to 18 months in advance — and a minimum 2-night stay is required. We coordinate the resort reservation and tee times simultaneously, ensuring your group gets the dates you want."
      ...
      courses={[
        ...
        { name: 'Del Monte Golf Course', type: 'Public · Monterey, CA', green_fee: 'Budget alternative', highlight: 'The oldest operating golf course west of the Mississippi (1897). Budget-friendly round in Monterey for groups who want to warm up before tackling Pebble Beach. $50–From $100/round.', booking_note: 'Budget warm-up option' },
      ]}
      faqs={[
        {
